    ...
    Tables: {
      calculs_solaires: {
        Row: {
          ...
          cee_eur: number | null
          co2_evite_tonnes_an: number | null
          cout_installation_eur: number | null
          cout_kwc_eur: number | null
          created_at: string
          economie_20ans_eur: number | null
          economie_annuelle_eur: number
          id: string
          inclinaison_deg: number | null
          nb_panneaux_max: number
          nb_panneaux_retenus: number | null
          overlay_svg_url: string | null
          prime_autoconsommation_eur: number | null
          production_kwh_an: number
          prospect_id: string
          puissance_kwc: number
          retour_investissement_ans: number | null
          revenu_surplus_an_eur: number | null
          satellite_image_url: string | null
          source_api: string
          suramortissement_eur: number | null
          surface_toiture_utile_m2: number | null
          tarif_oa_surplus_eur_kwh: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "calculs_solaires_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
      ...
      microsites: {
        Row: {
          ...
          echeance_aper: string | null
          echeance_dec_tert: string | null
          first_visit_at: string | null
          id: string
          image_overlay_url: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "microsites_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
            referencedRelation: "prospects"
            referencedColumns: ["id"]
      ...
      outreach_contacts: {
        Row: {
          ...
          created_at: string
          date_opt_out: string | null
          desabonne: boolean | null
      ...
      outreach_emails: {
        Row: {
          ...
          reponse_categorie: string | null
          reponse_confiance: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "outreach_emails_campagne_id_fkey"
            columns: ["campagne_id"]
            isOneToOne: false
            referencedRelation: "outreach_campagnes"
            referencedColumns: ["id"]
          },
          {
      ...
      prospects: {
        Row: {
          ...
          obligation_aper: boolean | null
          obligation_dec_tert: boolean | null
